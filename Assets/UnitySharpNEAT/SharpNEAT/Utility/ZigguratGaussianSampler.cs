...
namespace UnitySharpNEAT.SharpNEAT.Utility
{
    ...
    public class ZigguratGaussianSampler
    {
        ...
        /// Number of blocks.
        /// </summary>
        private const int __blockCount = 128;
        /// <summary>
        ...
        private readonly double _A_Div_Y0;
        ...
        public ZigguratGaussianSampler(FastRandom rng)
        {
            ...
            for(var i=1; i<__blockCount-1; i++) {

...
namespace UnitySharpNEAT.SharpNEAT.Utility
{
    ...
    public class DoubleCircularBufferWithStats
    {
        ...
        /// </summary>
        /// 
        [SerializeField] private readonly double[] _buff;

        /// <summary>
        /// The sum total of all valid values within the buffer. 
        /// </summary>
        [SerializeField] private double _total = 0.0;
        ...
        /// </summary>
        [SerializeField] private int _tailIdx;

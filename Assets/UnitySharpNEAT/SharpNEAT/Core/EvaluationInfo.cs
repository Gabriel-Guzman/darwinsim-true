...
namespace UnitySharpNEAT.SharpNEAT.Core
{
    /// <summary>
    ...
    {
        [SerializeField] private readonly DoubleCircularBufferWithStats _fitnessHistory;
        [SerializeField] private readonly int _fitnessHistoryLength;

        [SerializeField] private double _fitness;
        [SerializeField] private bool _isEvaluated;
        [SerializeField] private uint _evaluationCount;
        [SerializeField] private uint _evaluationPassCount;
        [SerializeField] private AuxFitnessInfo[] _auxFitnessArr;

...
namespace UnitySharpNEAT.SharpNEAT.Core
{
    ...
    {
        [SerializeField] private readonly UpdateMode _updateMode;
        [SerializeField] private readonly uint _generations;
        [SerializeField] private readonly TimeSpan _timespan;

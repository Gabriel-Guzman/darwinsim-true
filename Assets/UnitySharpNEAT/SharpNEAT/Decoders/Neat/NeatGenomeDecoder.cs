...
namespace UnitySharpNEAT.SharpNEAT.Decoders.Neat
{
    /// <summary>
    ...
    {
        [SerializeField] private readonly NetworkActivationScheme _activationScheme;

        private delegate IBlackBox DecodeGenome(NeatGenome genome);
        [SerializeField] private readonly DecodeGenome _decodeMethod;

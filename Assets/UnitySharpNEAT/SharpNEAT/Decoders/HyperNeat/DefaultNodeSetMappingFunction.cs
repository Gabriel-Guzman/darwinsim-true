...
namespace UnitySharpNEAT.SharpNEAT.Decoders.HyperNeat
{
    ...
    public class DefaultNodeSetMappingFunction : INodeSetMappingFunction
    {
        ...
        /// </summary>
        private readonly double? _maximumConnectionDistance;
        ...
        /// </summary>
        private readonly double? _maximumConnectionDistanceSquared;
        ...
        public IEnumerable<SubstrateConnection> GenerateConnections(SubstrateNodeSet srcNodeSet, SubstrateNodeSet tgtNodeSet)
        {
            ...
            {   
                ...
                foreach(var srcNode in srcNodeSet.NodeList)
                {
                    foreach(var tgtNode in tgtNodeSet.NodeList)
                    {
        ...
        public int GetConnectionCountHint(SubstrateNodeSet srcNodeSet, SubstrateNodeSet tgtNodeSet)
        {
            ...
            var count = 0;
            foreach(var conn in GenerateConnections(srcNodeSet, tgtNodeSet)) {
                count++;
            }
            return count;
        }

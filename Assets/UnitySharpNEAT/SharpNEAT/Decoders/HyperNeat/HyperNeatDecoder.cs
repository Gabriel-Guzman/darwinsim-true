...
namespace UnitySharpNEAT.SharpNEAT.Decoders.HyperNeat
{
    ...
    public class HyperNeatDecoder : IGenomeDecoder<NeatGenome,IBlackBox>
    {
        ...
        [SerializeField] private readonly bool _lengthCppnInput;
        ...
        {
            // Decode the CPPN.
            var cppn = _decodeCppnMethod(genome);

            // Generate a network definition from the CPPN and Substrate.
            var substrateNetworkDef = _substrate.CreateNetworkDefinition(cppn, _lengthCppnInput);

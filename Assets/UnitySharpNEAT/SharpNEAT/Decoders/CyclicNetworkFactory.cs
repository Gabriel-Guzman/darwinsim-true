...
using UnitySharpNEAT.SharpNEAT.Phenomes.NeuralNets.CyclicNetwork;
...
namespace UnitySharpNEAT.SharpNEAT.Decoders
{
    ...
    public class CyclicNetworkFactory
    {
                                           ...
                                           out List<Connection> connectionList)
        {
            ...
            var nodeDefList = networkDef.NodeList;
            var nodeCount = nodeDefList.Count;
            ...
            // Loop neuron genes.
            var activationFnLib = networkDef.ActivationFnLibrary;
            ...
            {   // Create a Neuron, add it to the neuron list and add an entry into neuronDictionary -
                ...
                // be introduced.
                var neuron = new Neuron(nodeDef.Id,
                                           nodeDef.NodeType,
            ...
            var connectionDefList = networkDef.ConnectionList;
            var connectionCount = connectionDefList.Count;
            connectionList = new List<Connection>(connectionCount);

            // Loop connection genes.
            for(var i=0; i<connectionCount; i++)
            {
                var connDef = connectionDefList[i];
                connectionList.Add(

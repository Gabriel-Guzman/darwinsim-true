...
namespace UnitySharpNEAT.SharpNEAT.Network.ActivationFunctions.RadialBasis
{
    /// <summary>
    ...
    public class RbfGaussian : IActivationFunction
    {
        ...
        private readonly double _auxArgsMutationSigmaCenter;
        private readonly double _auxArgsMutationSigmaRadius;
        ...
        public double Calculate(double x, double[] auxArgs)
        {
            ...
            var d = (x-auxArgs[0]) * Math.Sqrt(auxArgs[1]) * 4.0;
            return Math.Exp(-(d*d));
        }
        ...
        public float Calculate(float x, float[] auxArgs)
        {
            // auxArgs[0] - RBF center.
            // auxArgs[1] - RBF gaussian epsilon.
            var d = (x-auxArgs[0]) * (float)Math.Sqrt(auxArgs[1]) * 4f;
        ...
        public void MutateAuxArgs(double[] auxArgs, FastRandom rng, ZigguratGaussianSampler gaussianSampler, double connectionWeightRange)
        {
            ...
            var tmp = auxArgs[0] + gaussianSampler.NextSample(0, _auxArgsMutationSigmaCenter);

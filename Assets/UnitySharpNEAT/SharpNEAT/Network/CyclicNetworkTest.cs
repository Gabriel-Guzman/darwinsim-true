...
namespace UnitySharpNEAT.SharpNEAT.Network
{
    ...
    public class CyclicNetworkTest
    {
        ...
        /// </summary>
        private readonly HashSet<uint> _ancestorNodeSet = new HashSet<uint>();
        /// <summary>
        /// Set of all visted nodes. This allows us to quickly determine if a path should be traversed or not. 
        /// </summary>
        private readonly HashSet<uint> _visitedNodeSet = new HashSet<uint>();
        ...
        private bool TraverseNode(uint nodeId)
        {
            ...
            var node = _networkConnectivityData.GetNodeDataById(nodeId);
            ...
            foreach(var targetId in node._tgtNodes)
            {

...
namespace UnitySharpNEAT.SharpNEAT.Phenomes.NeuralNets.AcyclicNetwork
{
    /// <summary>
    ...
    //=== Fixed data. Network structure and activation functions/data.
        ...
        /// </summary>
        private readonly IActivationFunction[] _nodeActivationFnArr;
        /// <summary>
        /// Array of node activation function auxiliary arguments.
        /// </summary>
        private readonly double[][] _nodeAuxArgsArr;
        /// <summary>
        /// Array of connections.
        /// </summary>
        private readonly FastConnection[] _connectionArr;
        /// <summary>
        ...
        /// </summary>
        private readonly LayerInfo[] _layerInfoArr;

    //=== Working data.
        /// <summary>
        /// Array of node activation signals.
        /// </summary>
        private readonly double[] _activationArr;
    ...
    //=== Misc.
        ...
        private readonly MappingSignalArray _outputSignalArrayWrapper;

        // Convenient counts.
        private readonly int _inputNodeCount;
        private readonly int _outputNodeCount;
        private readonly int _inputAndBiasNodeCount;
        ...
        {   
            ...
            for(var i=_inputAndBiasNodeCount; i<_activationArr.Length; i++) {
                _activationArr[i] = 0.0;
            }

            // Process all layers in turn.
            int conIdx=0, nodeIdx=_inputAndBiasNodeCount;
            for(var layerIdx=1; layerIdx < _layerInfoArr.Length; layerIdx++)
            {
                var layerInfo = _layerInfoArr[layerIdx-1];

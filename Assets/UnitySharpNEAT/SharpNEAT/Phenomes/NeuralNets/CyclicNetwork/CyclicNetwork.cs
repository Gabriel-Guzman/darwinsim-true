...
namespace UnitySharpNEAT.SharpNEAT.Phenomes.NeuralNets.CyclicNetwork
{
    ...
    public class CyclicNetwork : IBlackBox
    {
        ...
        public virtual void Activate()
        {
            ...
            for(var i=0; i<_timestepsPerActivation; i++)
            {
        ...
        public virtual void ResetState()
        {
            ...
            for(var i=1; i<_inputAndBiasNeuronCount; i++) {
                _neuronList[i].OutputValue = 0.0;
            }

            // Reset input and output value of all remaining neurons (output and hidden neurons).
            var count = _neuronList.Count;
            for(var i=_inputAndBiasNeuronCount; i<count; i++) {   
